...
| 2 | Ingestion: scheduled pulls from Zoho / D-Tools / QBO | ✅ built — awaiting credential load; QBO production access open (app assessment completed and app authorized against LIVEWIRE LLC 2026-08-18), [docs/phase-2-credentials.md](docs/phase-2-credentials.md) |
