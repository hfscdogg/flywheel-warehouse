...
| 4 | Agent access: MCP endpoint + goal cards | 🚧 endpoint **live for Livewire** 2026-08-25 — Hermes Agent querying `marts` via Cloud Run, raw access verified denied from the agent's seat ([hermes-mcp/](hermes-mcp/), [docs/phase-4-hermes-endpoint.md](docs/phase-4-hermes-endpoint.md)); first three goal cards written; sales won and AR over 90 active with targets, subscription leak awaiting one — [goal-cards/](goal-cards/README.md) |
