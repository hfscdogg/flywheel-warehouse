...
| 2 | Ingestion: scheduled pulls from Zoho / D-Tools / QBO | ✅ built — awaiting credential load; QBO app assessment submitted 2026-08-18, pending Intuit approval, [docs/phase-2-credentials.md](docs/phase-2-credentials.md) |
